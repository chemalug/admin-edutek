...
class Ion_auth_model extends CI_Model {
    ...
    public function salt() {
        ...
        if (function_exists('random_bytes') && !defined('PHALANGER')) {
            ...
            //$buffer = random_bytes($raw_salt_len, MCRYPT_DEV_URANDOM);
            if ($buffer) {
                $buffer_valid = true;
            }
        }
     ...
     * @author Mathew
     */
    public function activar($id, $code = false) {
    ...
    public function backup_codes($id) {
        ...
        for ($n = 0; $n < $this->otp['backup_codes_length']; $n++) {
            ...
            $characters = 'ACDEFGHJKLMNPRSTUVWXYZ';
            ...
            // frendly backup code
            $key = $characters[rand(0, strlen($characters) - 1)].rand(0, 9).rand(0, 9).rand(0, 9).rand(0, 9).rand(0, 9).rand(0, 9);
