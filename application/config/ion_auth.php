 ...
 */
$config['site_title']         = "INTECAP";          // Site Title, example.com
$config['admin_email']        = "noreply@intecap.edu.gt";      // Admin Email, admin@example.com
$config['default_group']      = 'pedagogico';      // Default group, use name
...
$config['register_users']         = FALSE;      // Any one can register
...
$config['email_config'] = array(
    ...
    'smtp_port' => 465,
    'smtp_user' => 'administrador@qomtecsoft.com',
    'smtp_pass' => '2eo24oChema',
    'mailtype'    =>  'html',
    'charset'     =>  'UTF-8',
    'newline'     =>  "\r\n",
);
...
$config['otp']['issuer'] = "LYNX GT";  // A provider/issuer shown as a title on OTP mobile apps
