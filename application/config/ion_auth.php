 ...
 */
$config['site_title']         = "Edutek";          // Site Title, example.com
$config['admin_email']        = "noreply@edutek.org";      // Admin Email, admin@example.com
$config['default_group']      = 'profesor';      // Default group, use name
