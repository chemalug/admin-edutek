                                            ...
                                            <div class="dd-handle" style="background-color:#90908d;" >
                                                <div class="row" >
                                                    ...
                                                    <div class="col-md-4 text-right">
                                                        ...
                                                        <a href="#" class="modificarleccion" style="font-size:17px;color:white;" id="{{ $leccion->id }}" data-toggle="tooltip" data-original-title="Modificar Lección" data-key="{{ $leccion->titulo }}" > <i class="fas fa-edit"></i></a> |
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-4 text-right">
                                                                        @if ($tema->es_actividad == 0)
                                                                            ...
                                                                            <a href="#" class="modificarcontenido" style="font-size:15px;color:white" id="{{ $tema->id }}" data-toggle="tooltip" data-original-title="Modificar actividad" data-key="{{ $tema->titulo }}:{{$tema->punteo}}"> <i class="fas fa-edit"></i></a> |
                                                                ...
                                                                <ol class="dd-list">
                                                                    <li class="dd-item" data-id="b-{{ $tema->id }}-{{ $leccion->id }}">
                                                                        <div class="dd-handle">
                                                                            <div class="row">
                                                                                <div class="col-md-4">
                                                                                    <a href="#" class="deleteContenido " style="font-size:15px;color:white" id="{{ $tema->id }}" data-toggle="tooltip" data-original-title="">{{ $tema->archivo }}</a> 
                                                                                </div>
