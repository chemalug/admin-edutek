                    ...
                    <form class="form p-t-20">
                        <div class="form-group">
                          <input type="text" class="form-control" name="id" id="id" hidden value="{{ $datos->id }}" >
                            ...
                            <input type="text" class="form-control" style="color:white;" name="nombre" id="nombre" placeholder="Nombre" style="color:white;" value="{{ $datos->nombre }}" >
                            </div>
                        </div>
                          <div class="form-group">
                            <br>
                            ...
                            <div class="input-group">
                                ...
                                <textarea class="form-control" style="color:white;" name="descripcion" id="descripcion" placeholder="Descripción" maxlength="1500">{{ $datos->descripcion }}</textarea>
                            </div>
                            <div class="form-group">
                                    <br>
                                ...
                                <div class="input-group">
                                    ...
                                    <textarea class="form-control" style="color:white;" name="objetivos" id="objetivos" placeholder="Objetivos" maxlength="1500">{{ $datos->objetivos }}</textarea>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control" style="color:white;" name="duracion" id="duracion" placeholder="" value="20" min="10" max="120" value="{{ $datos->duracion }}">
                                    </div>
                                    <div class="form-group">
                                            <br>
                                        ...
                                        <div class="input-group">
                                            ...
                                            <textarea class="form-control" style="color:white;" name="requisitos" id="requisitos" placeholder="Requisitos" maxlength="1500">{{ $datos->requisitos }}</textarea>
                                        </div>
                                        <div class="form-group">
                                                <br>
                                            ...
                                            <div class="input-group">
                                                ...
                                                <textarea class="form-control" style="color:white;" name="dirigido_a" id="dirigido_a" placeholder="Dirigido a ..." maxlength="1500">{{ $datos->dirigido }}</textarea>
                                            </div>
                                            <div class="form-group">
                                                    <br>
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control" style="color:white;" name="codigo_plan" id="codigo_plan" placeholder="Código del plan de formación" value="{{ $datos->codigo_plan_formacion }}">
                                                </div>
                                                <div class="form-group">
                                                    <br/>
