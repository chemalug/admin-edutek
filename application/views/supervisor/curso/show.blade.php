...
<div class="card">
    <div class="card-body">
        <h2 class="card-title">Intecap E-learning</h2>
        <h4 class="card-title">Listado de cursos disponibles INTECAP | TICS</h4>
            ...
            <table class="table full-color-table full-inverse-table hover-table" id="table_principal">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ date('d-m-Y H:i', strtotime($item->fecha_creacion)) }}</td>
