                        ...
                        <div class="row card-subtitle">
                            ...
                            <a href="{{ base_url() }}evento/dosificacion/{{ $evento_id }}" class="btn btn-success waves-effect waves-light m-r-10" style="color:white;width:195px;">Subir Dosificación<i class="mdi mdi-grease-pencil"></i> </a>
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <a class="dropdown-item" href="{{ base_url() }}uploads/assets/formato_inscripcion.xlsx">Descargar formato</a>   
                                </div>
                                <a href="{{ base_url() }}evento/evaluar/{{ $evento_id }}" class="btn btn-warning waves-effect waves-light m-r-10" style="color:white;width:195px;">Ponderar actividades <i class="mdi mdi-grease-pencil"></i> </a>
                                @if($banderacerrar == 1) 
                                    <button class="btn btn-danger waves-effect waves-light m-r-10 cerrarevento" id="{{ $evento_id }}" style="color:white;width:195px;" >Cerrar evento <i class="mdi mdi-close"></i> </button>
                                @else
                                    <button class="btn btn-danger waves-effect waves-light m-r-10 cerrarevento" id="{{ $evento_id }}" style="color:white;width:195px;" disabled>Cerrar evento <i class="mdi mdi-close"></i> </button>
                                @endif
                            </div>
                        </div>
                        <div class="row">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $(document).on('keypress', "#carnet", function(e) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if (data != 0) {
                            ...
                            alert('No se encontró ningún participante asociado a ese carnet!')
                            /*Swal.fire({
                                type: 'error',
                                title: 'Oops...',
